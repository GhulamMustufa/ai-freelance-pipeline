                    ...
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      ...
                      <div className="truncate">
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-3 mt-1">
                          ...
                          {opp.score && <span>Match: {Math.round(opp.score.skillMatch * 100)}%</span>}
                        </div>
                      </div>
                    </div>
                  ...
                  {isExpanded && (
                    <div className="px-5 pb-5 pt-2 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/50">
                      <div className="space-y-3">
                        ...
                        <div className="pt-2">
                           <span className="text-xs text-slate-400 italic">Full proposal viewing coming soon in next iteration...</span>
                        </div>
                      </div>
                    </div>
                  )}
