  ...
  return (
    <section className="py-28 bg-white dark:bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-radial from-warning/12 via-transparent to-transparent rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">
          ...
          <br />
          <span className="text-warning">The question is whether it&apos;s worth your time.</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-warning hover:bg-warning text-slate-950 font-bold text-lg rounded-xl transition-all shadow-xl shadow-warning/25 hover:shadow-warning/35 hover:-translate-y-0.5"
          >
            Analyze a Job Free
