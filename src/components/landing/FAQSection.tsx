    ...
    <section className="py-24 bg-slate-900" id="faq">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-14">
          ...
          <p className="text-slate-400 text-lg">Honest answers to common questions.</p>
        </div>
          ...
          {faqs.map((faq, i) => (
            <div
              ...
              className={`bg-slate-950 border rounded-xl overflow-hidden transition-all duration-200 ${
                open === i ? "border-amber-500/30" : "border-slate-800 hover:border-slate-700"
              }`}
            >
              <button
              ...
              >
                <span className={`font-semibold text-sm leading-relaxed ${open === i ? "text-white" : "text-slate-300 group-hover:text-white"} transition-colors`}>
                  {faq.q}
                </span>
