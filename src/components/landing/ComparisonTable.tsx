export default function ComparisonTable() {
  ...
  return (
    <section className="py-24 bg-slate-50 dark:bg-slate-950" id="why-omnibid">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop table */}
        <div className="hidden md:block overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80">
        ...
        <div className="md:hidden space-y-3">
          {rows.map((r) => (
            <div key={r.feature} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 space-y-2">
              <div className="text-xs font-bold text-slate-500 dark:text-slate-500 uppercase tracking-wider">{r.feature}</div>
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  <div className="text-[10px] text-slate-600 dark:text-slate-600 mb-1">Typical Tool</div>
